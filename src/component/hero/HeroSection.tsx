  ...
  <section className={`${styles.heroSection} container`}>
    <div className={styles.heroContent}>
      ...
      <p className={styles.description}>
        ...
        humain d'une organisation publique ou privée, DEO Conseil a pour raison d'être de
        faire grandir les hommes et les organisations en donnant du sens à toutes les
        parties prenantes.
      </p>
